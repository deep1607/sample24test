...
/**
 * 
 * Sample24testExceptionHandler is a controller advice which captures any of the exceptions in the process of api execution.
 *
 */
@ControllerAdvice
public class Sample24testExceptionHandler extends ResponseEntityExceptionHandler{

	private static final Logger log = LoggerFactory.getLogger(Sample24testExceptionHandler.class);
	...
	/**
	 * Sample24testException handler
	 * @param Sample24testException
	 * @param request
	 * @return
	 */
	@ExceptionHandler(value = { Sample24testException.class })
	protected ResponseEntity<Object> handleRequestException(Sample24testException exception, WebRequest request) {
		// build header responses
		final HttpHeaders httpHeaders = getResponseHeaders(request);
