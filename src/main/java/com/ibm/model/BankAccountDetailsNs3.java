...
public class BankAccountDetailsNs3   {
  ...
  private String defaultAccountFlag;

  @JsonProperty("defaultFastCashAccountFlag")
  private String defaultFastCashAccountFlag;

  @JsonProperty("defaultPurchaseAccountFlag")
  private String defaultPurchaseAccountFlag;

  @JsonProperty("directDebitEnabledFlag")
  private String directDebitEnabledFlag;
