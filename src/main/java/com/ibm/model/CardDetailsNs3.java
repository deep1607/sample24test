...
public class CardDetailsNs3   {
  ...
  private String corporateEmbossedName;
  ...
  private String formerExpiryDate;
  ...
  private String stopListFlag;

  @JsonProperty("stopListRangeDate")
  private String stopListRangeDate;

  @JsonProperty("stopListReasonCode")
  private String stopListReasonCode;
